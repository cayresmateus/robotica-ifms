...
<footer class="footer-portal">
	<div class="container">
		...
		<div class="row gy-4 gx-lg-5">
			...
			<div class="col-lg-4 col-md-6">
				<div class="d-flex align-items-center gap-3 mb-3">
					<div class="brand-icon" style="width: 40px; height: 40px; font-size: 18px; background: #059669;">
			...
			<div class="col-lg-2 col-md-6 col-6">
				<h6 class="text-uppercase fw-bold mb-3" style="color: #94A3B8; font-size: 13px; letter-spacing: 0.05em;">
			...
			<div class="col-lg-3 col-md-6 col-6">
				...
				<ul class="list-unstyled small d-flex flex-column gap-2 mb-0">
					...
					<li><a href="${pageContext.request.contextPath}/login" style="color: #F87171;"><i class="fa-solid fa-lock fa-xs me-1"></i> <fmt:message key="nav.admin" /></a></li>
				</ul>
			</div>
			...
			<div class="col-lg-3 col-md-6">
				...
				<div class="small d-flex flex-column gap-2" style="color: #CBD5E1;">
					<div class="d-flex align-items-start gap-2">
						<i class="fa-solid fa-location-dot mt-1" style="color: #10B981;"></i>
		...
		<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 small" style="color: #94A3B8;">
